//**Getting runing with Vizuly is as simple** as including
// <code>d3.js.min</code> and <code>vizuly.js.min</code> in your html and the following line in your javascript:
//
// <code>vizuly.viz.radialprogress(myElement).data(myData).update();</code>
//
// Thats it.
//
...
// the <code>BarTest.html</code> and <code>bar_test.js</code> file.
...
// <a href='http://blog.derraab.com/2013/05/30/start-google-chrome-with-local-file-access-on-mac-os-x/' target='_blank'>Mac</a>
// and <a href='http://chrisbitting.com/2014/03/04/allow-local-file-access-in-chrome-windows/' target='_blank'>Windows</a>
//
...
function initialize() {
    ...
    viz = vizuly.viz.bar(document.getElementById("viz_container"));
    ...
    // *See this <a href='http://vizuly.io/docs-themes-and-skins/' target='_parent'>guide</a> for understanding the details of themes and skins.*
    ...
    var legend = svg.append("g")
        ...
        .attr('transform', `translate(-20,${viz.height()-95})`);
    ...
    viz.xAxis().tickFormat(function (d,i) { return "" });
...
const datatipHtml =
   ...
   <b> Effective &nbsp;</b>
   <span class='datatip-value' style='color: #00FF00 !important'></span>
   <br/>
   <b> rate </b>
 </div>`;
...
function getSeriesIndex(val) {
    return viz.yScale().domain().indexOf(viz.y().apply(this, [val]));
}
